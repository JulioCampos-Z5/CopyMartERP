    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      >
        ...
        <template #actions>
          ...
          <button @click="clearFilters" class="px-4 py-2 border border-orange-300 text-orange-600 rounded-lg hover:bg-orange-50 flex items-center gap-2 transition-colors">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const columns = [
  ...
  },
  {
    key: 'billing_type',
    label: 'Tipo',
    format: (row: Billing) => row.billing_type?.toLowerCase() === 'venta' ? 'Venta' : 'Renta',
    cellClass: 'text-sm'
  },
  {
    key: 'reference',
...
const clearFilters = () => {
  ...
  filtersStore.clearFilters('billings')
  loadBillings()
}
